...
# cmd="python \"${TRANSFORM_SCRIPT}\" \"${DYNACT_ABAD_VOL_1}\" \"${WBCT_MC1}\" \"${FINAL_TFM_MC1_ABAD}\" "
# echo $cmd
# eval $cmd
# cmd="python \"${TRANSFORM_SCRIPT}\" \"${DYNACT_ABAD_VOL_1}\" \"${WBCT_TRP}\" \"${FINAL_TFM_TRP_ABAD}\" "
# echo $cmd
# eval $cmd
# cmd="python \"${TRANSFORM_SCRIPT}\" \"${DYNACT_OPP_VOL_1}\" \"${WBCT_MC1}\" \"${FINAL_TFM_MC1_OPP}\" "
# echo $cmd
# eval $cmd
# cmd="python \"${TRANSFORM_SCRIPT}\" \"${DYNACT_OPP_VOL_1}\" \"${WBCT_TRP}\" \"${FINAL_TFM_TRP_OPP}\" "
# echo $cmd
# eval $cmd
# cmd="python \"${TRANSFORM_SCRIPT}\" \"${DYNACT_KEY_VOL_1}\" \"${WBCT_MC1}\" \"${FINAL_TFM_MC1_KEY}\" "
# echo $cmd
# eval $cmd
# cmd="python \"${TRANSFORM_SCRIPT}\" \"${DYNACT_KEY_VOL_1}\" \"${WBCT_TRP}\" \"${FINAL_TFM_TRP_KEY}\" "
# echo $cmd
# eval $cmd
