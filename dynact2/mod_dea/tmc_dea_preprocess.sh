...
# .sh script intended to be run on ARC
...
echo Running tmc_dea_preprocess.sh
...
echo python $SCRIPT_DIR/tmc_dea_preprocess.py $INPUT_DIR $SUBJECT
python $SCRIPT_DIR/tmc_dea_preprocess.py $INPUT_DIR $SUBJECT