...
def image_registration(fixed_img, moving_img, ref_transform):
    ...
    reg.SetMetricSamplingPercentagePerLevel([0.01, 0.01, 0.001], 0)
...
if __name__ == "__main__":
    ...
    if study_id is None:
        moving_img_registered_path = os.path.join(output_path, "WBCT_TO_XCT_REG.nii")
        moving_img_tmat_path = os.path.join(output_path, "WBCT_TO_XCT_REG.tfm")
    else:
        moving_img_registered_path = os.path.join(output_path, study_id + "_WBCT_TO_XCT_REG.nii")
        moving_img_tmat_path = os.path.join(output_path, study_id + "_WBCT_TO_XCT_REG.tfm")
